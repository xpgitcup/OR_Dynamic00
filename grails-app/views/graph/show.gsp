...
<html>
    ...
    <body>
        ...
        <div id="show-graph" class="content scaffold-show" role="main">
            ...
            <f:display bean="graph" />
            <g:form resource="${this.graph}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.graph}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
